// Script unificado para gerenciar metas (criar, visualizar, editar, excluir)
document.addEventListener('DOMContentLoaded', function() {
  ...
  function formatDate(dateString) {
    ...
    // Ajustar para o fuso horário local correto
  ...
  // Inicializar modais manualmente
